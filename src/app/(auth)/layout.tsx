      ...
      <section className="hidden lg:flex flex-col justify-between bg-dark-900 text-light-100 p-10">
        ...
        <div className="space-y-4">
          ...
          <p className="max-w-md text-lead text-light-300">
            Join millions of athletes and fitness enthusiasts who trust Dike for their performance needs.
          </p>
        ...
        <p className="text-footnote text-light-400">© 2026 Dike. All rights reserved.</p>
      </section>
