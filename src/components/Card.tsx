    ...
    >
      ...
      <div className="p-4">
        <div className="mb-1 flex items-baseline justify-between gap-3">
          <h3 className="text-heading-3 text-dark-900 font-fair">{title}</h3>
          {displayPrice && <span className="text-body-medium text-dark-900">{displayPrice}</span>}
        </div>
        {description && <p className="text-body text-dark-700 font-modern">{description}</p>}
        {subtitle && <p className="text-body text-dark-700 font-modern">{subtitle}</p>}
        {meta && (
          <p className="mt-1 text-caption text-dark-700 font-modern ">
