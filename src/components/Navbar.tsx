...
export default function Navbar() {
  ...
  return (
    <header className="sticky top-0 z-50 font-fair bg-light-100">
      <nav
        className="mx-auto flex h-16 max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-8"
        aria-label="Primary"
      >
        <Link href="/" aria-label="Dike Home" className="flex items-center">
          <Image src="/logo.svg" alt="Dike" width={28} height={28} priority className="invert" />
        </Link>
        ...
        <div className="hidden items-center gap-6 md:flex">
          ...
          <Link
            href="/sign-up"
            className="rounded-full bg-dark-900 px-4 py-2 text-body text-light-100 hover:opacity-90"
          >
            Sign Up
          </Link>
        </div>
      ...
      >
        <ul className="space-y-2 px-4 py-3">
          ...
          <li className="flex items-center justify-between pt-2">
            <Link href="/cart" className="text-body">My Cart</Link>
